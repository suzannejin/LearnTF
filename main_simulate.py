...
"""
import argparse
from src.data_SimulatedDataClass import SimulatedData
from src.data_TfFamilyClass import TfFamily
...
if __name__ == "__main__":
    ...
    simulated_data = SimulatedData(tf_data, n=50, l=10)
    print(simulated_data.data)
